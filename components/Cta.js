...
const Cta = () =>{
    return(
        <div className="flex items-center justify-center flex-col">
            <h1 className={`${Clash.className} text-lg sm:text-3xl mt-4 md:text-4xl lg:text-5xl text-black text-center `}>Ready to take your salon to the next level?<br/> Contact us today for a free demo </h1>
            <motion.button
